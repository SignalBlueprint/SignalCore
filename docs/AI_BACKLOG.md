...
|----|-----|-------|----------|--------|--------|-------|---------------------|----------|
| P1 | Console, Questboard, Catalog, LeadScout, SiteForge, Outreach | Frontend Authentication Integration | 🔥 CRITICAL | Open | 🔓 | `packages/ui/src/auth/`, `apps/*/web/src/auth/`, `apps/*/web/src/api/` | - Shared login/signup components<br>- Auth state management<br>- JWT tokens in API calls<br>- Protected routes<br>- Logout UI | **Blocks:** Production security<br>**Effort:** 5-7 days<br>**Impact:** Enables secure multi-tenant use |
...
| P3 | SiteForge | SiteForge Template Variations | 🔥 HIGH | Open | 🔓 | `apps/siteforge/src/services/generator/templates/`, `apps/siteforge/src/services/generator/themes/` | - 4+ visual styles<br>- 5+ industry templates<br>- Theme customization<br>- Template preview gallery | **Blocks:** Customer choice<br>**Effort:** 6-8 days<br>**Impact:** Unlocks sales |
| P4 | Console | Console Data Persistence | 🔥 HIGH | Open | 🔓 | `apps/console/src/repositories/teamRepository.ts`, `packages/schemas/src/team.ts` | - Migrate team data to @sb/storage<br>- CRUD endpoints<br>- Settings persistence | **Blocks:** Production use<br>**Effort:** 2-3 days<br>**Impact:** Data durability |
...
| P8 | Catalog | Catalog Product Variants | ⚡ MEDIUM | Open | 🔓 | `packages/schemas/src/product.ts`, `apps/catalog/src/repositories/productRepository.ts`, `apps/catalog/web/product-detail.html` | - Variant schema<br>- Variant inventory<br>- Selection UI<br>- Cart/order updates | **Unlocks:** E-commerce features<br>**Effort:** 4-5 days<br>**Impact:** Product flexibility |
