...
- **📸 Image Upload**: Take photos on your phone and upload via API
- **👁️ AI Vision Analysis**: Automatic product metadata extraction using OpenAI Vision
...
- **📖 Lookbooks**: Organize products into collections
...
Storage (Supabase/Local)
    ↓
OpenAI Vision Analysis → Metadata Extraction
    ↓
OpenAI Embeddings → Vector for Search
    ↓
DALL-E 3 → Clean Product Shot
    ↓
