...
| P4 | Console | Console Data Persistence | 🔥 HIGH | READY | 🔓 | `apps/console/src/repositories/teamRepository.ts`, `apps/console/src/routes/team.ts`, `packages/schemas/src/team.ts`, `packages/storage/src/repositories/teamRepository.ts`, `apps/console/src/routes/settings.ts` | - Migrate team data to @sb/storage<br>- CRUD endpoints<br>- Settings persistence | **Blocks:** Production use<br>**Effort:** 2-3 days<br>**Impact:** Data durability |
